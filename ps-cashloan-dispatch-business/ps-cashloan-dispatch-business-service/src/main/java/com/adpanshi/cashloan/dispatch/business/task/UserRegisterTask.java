...
public class UserRegisterTask implements Task {
    ...
    public DispatchRunResponseBo run(Integer taskInstanceId) {
        LOGGER.info("【提交用户注册基本信息 taskInstanceId={}】", taskInstanceId);
        ...
        try {
            ...
            if (id != null) {
                ...
                return DispatchRunResponseBo.error(StatusCode.USER_REGISTER_FAIL);
            }
        } catch (Exception e) {
            LOGGER.error("【提交用户注册基本信息异常，异常信息： 】", e);
            ...
            return DispatchRunResponseBo.error(StatusCode.USER_REGISTER_FAIL, e.getMessage());
        }
    }
}
